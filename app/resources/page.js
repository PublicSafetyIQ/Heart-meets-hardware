    ...
    content: [
      {
        ...
        link: { label: 'Read ADOA Policy P2000 →', href: 'https://aset.az.gov/sites/default/files/2024-10/P2000%20-%20Generative%20AI%20Policy%20_0.pdf' },
      },
      {
      ...
      },
      {
        ...
        body: 'In May 2025, Governor Hobbs established Arizona\'s first AI Steering Committee to develop a statewide AI policy framework. Arizona AI legislation is actively evolving — what\'s permitted today may be regulated tomorrow.',
        link: { label: 'Arizona AI Steering Committee →', href: 'https://aset.az.gov/announcementnews/governor-katie-hobbs-announces-members-arizonas-first-ai-steering-committee' },
      },
    ],
  },
  {
    ...
    content: [
      {
        ...
        link: { label: 'Read ARS §39-121 →', href: 'https://www.azoca.gov/arizona-public-records-law/' },
      },
      {
        ...
        link: { label: 'Poynter: How journalists are FOIAing ChatGPT logs from government →', href: 'https://www.poynter.org/reporting-editing/2025/how-to-foia-chatgpt-logs-government-public-records/' },
      },
      {
