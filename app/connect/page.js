    ...
    <main className="min-h-screen flex flex-col px-6 py-10 max-w-md mx-auto">
      ...
      {submitted ? (
        ...
        <div className="space-y-4">
          <Field label="Name *" value={form.name} onChange={(v) => handleChange('name', v)} placeholder="" />
          <Field label="Email *" value={form.email} onChange={(v) => handleChange('email', v)} placeholder="" type="email" />
          <Field label="Phone (optional)" value={form.phone} onChange={(v) => handleChange('phone', v)} placeholder="" type="tel" />
          <Field label="Department (optional)" value={form.department} onChange={(v) => handleChange('department', v)} placeholder="" />
          <div>
