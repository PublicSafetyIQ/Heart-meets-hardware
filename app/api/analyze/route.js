...
Total respondents: ${total}`;
    ...
    const prompt = `Format your response using only these elements: # for main section titles, ## for subsection headings, ### for subheadings, **bold** for emphasis, - for bullet points, and --- for dividers between major sections. Do not use > blockquote formatting anywhere. Write all paragraphs as plain text.

You have the personality distribution data from a room of fire service leaders attending a conference. The distribution across DiSC styles is as follows:
...
Write the announcement so that each DiSC style would feel the message was written with them in mind. Do not open the announcement with a generic salutation such as 'To all members of this department' or similar. Open with a compelling subject line and go directly into the message with authority and intention.
