    ...
    <main className="min-h-screen flex flex-col items-center justify-between px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div style={{display:'flex',alignItems:'center',gap:'16px'}}>
          <img src="/logo.png" alt="Heart Meets Hardware" style={{width:'150px',flexShrink:0}} />
          <h1 className="font-serif text-4xl text-hmh-cream leading-tight">Heart Meets Hardware</h1>
        </div>

        {/* Subtitle full width under both */}
        <p className="text-hmh-cream-dim text-lg italic mt-3 mb-6">Serving People in a Digital World</p>
